...
QT_MOC_LITERAL(1, 9, 11), // "need_update"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11) // "error_exist"

    },
    "DataBase\0need_update\0\0error_exist"
};
...
void DataBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->error_exist((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataBase::need_update)) {
                *result = 0;
            }
        }
        {
            typedef void (DataBase::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataBase::error_exist)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void DataBase::need_update()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void DataBase::error_exist(int _t1)
{
